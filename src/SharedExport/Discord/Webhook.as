namespace DiscordNotify {
    ...
    */
    shared class Webhook {
        ...
        Webhook(int id, const string &in token) {
            ID = id;
            Token = token;
        ...
        */
        WebhookResponse@ Get() {
            ...
            if (request.ResponseCode() == 200)
                return WebhookResponse(request.String());
        ...
        Returns the webhook information or `null` on failure.
        */
        WebhookResponse@ Modify(const string &in body) {
        ...
        */
        Message@ Execute(WebhookMessage@ message, bool wait = false/*, DiscordSnowflake@ threadID = null*/) {
            ...
            if (request.ResponseCode() == 200)
                return Message(Json::Parse(request.String()));
        ...
        */
        Message@ GetMessage(int messageID/*, DiscordSnowflake@ threadID = null*/) {
        ...
        Returns the message or `null` on failure.
        */
        Message@ EditMessage(int messageID, WebhookMessage@ message/*, DiscordSnowflake@ threadID = null*/) {
            string url = this.MessagesEndpoint + "/" + messageID;
            string body = message.ToString();
